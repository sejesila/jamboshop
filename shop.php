    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            if (!isset($_GET['p_cat'])) {
              ...
              <div class='box'>
             <h1>Shop</h1>
             <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, numquam! Lorem ipsum dolor sit amet consectetur, adipisicing elit. In itaque, aperiam, praesentium ad modi aliquid laudantium quo recusandae deleniti voluptate nemo hic similique numquam sapiente deserunt qui consequuntur? Magnam quam eos numquam repellat, corporis ut autem architecto, et, aut veritatis doloribus placeat tempora?</p>
             </div>";
            }
            ?>
