        ...
        <div class="row">
            ...
            <div class='col-sm-8'>
                ...
                <div class='qty d-flex pt-2'>
                    ...
                    <button type='button'  onclick=\"window.location.href='action.php?remove';\" class='btn text-danger px-3 border-right'>Delete</button>
            ...
            <div class="col-sm-4 pl-6">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <button type="button"  onclick="window.location.href='checkout.php';" class=" btn btn-warning mt-3 <?= ($total>1)?"":"disabled"; ?>">Proceed to Checkout</button>
